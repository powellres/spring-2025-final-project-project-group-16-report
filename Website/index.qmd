...
By Sheeba Moghal, Powell Sheagren, Ishaan Babbar, Yuting Fan
...
## Retrieval Techniques and Future Considerations
...
## Model Selection and Bedrock Integration
...
[The Demo for this project can be found here](https://drive.google.com/file/d/1w_8eRBAkY695tvmyF4ooMfVrEL3oUi8p/view?usp=sharing)
...
[https://vijaykumarkartha.medium.com/hierarchical-ai-agents-create-a-supervisor-ai-agent-using-langchain-315abbbd4133](https://vijaykumarkartha.medium.com/hierarchical-ai-agents-create-a-supervisor-ai-agent-using-langchain-315abbbd4133)

[https://python.langchain.com/api\_reference/langchain/chains/langchain.chains.retrieval\_qa.base.RetrievalQA.html](https://python.langchain.com/api_reference/langchain/chains/langchain.chains.retrieval_qa.base.RetrievalQA.html)
...
[https://python.langchain.com/v0.2/docs/integrations/tools/python/](https://python.langchain.com/v0.2/docs/integrations/tools/python/)

[https://python.langchain.com/v0.2/docs/integrations/callbacks/streamlit/](https://python.langchain.com/v0.2/docs/integrations/callbacks/streamlit/)

[https://python.langchain.com/docs/how\_to/agent\_executor/](https://python.langchain.com/docs/how_to/agent_executor/)

[https://python.langchain.com/api\_reference/langchain/agents/langchain.agents.tool\_calling\_agent.base.create\_tool\_calling\_agent.html](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.tool_calling_agent.base.create_tool_calling_agent.html)

[https://python.langchain.com/v0.1/docs/modules/agents/agent\_types/react/](https://python.langchain.com/v0.1/docs/modules/agents/agent_types/react/)

[https://python.langchain.com/v0.1/docs/modules/memory/agent\_with\_memory/](https://python.langchain.com/v0.1/docs/modules/memory/agent_with_memory/)

[https://python.langchain.com/docs/concepts/messages/](https://python.langchain.com/docs/concepts/messages/)

[https://www.reddit.com/r/AI\_Agents/comments/1jk7poi/i\_built\_an\_ai\_agent\_that\_adds\_meaningful\_comments/](https://www.reddit.com/r/AI_Agents/comments/1jk7poi/i_built_an_ai_agent_that_adds_meaningful_comments/)

[https://medium.com/@jaimonjk/how-can-large-token-limits-in-new-llm-models-transform-the-learning-and-development-function-5fc643c8df0d](https://medium.com/@jaimonjk/how-can-large-token-limits-in-new-llm-models-transform-the-learning-and-development-function-5fc643c8df0d)

[https://medium.com/@ashpaklmulani/multi-agent-with-langgraph-23c26e9bf076](https://medium.com/@ashpaklmulani/multi-agent-with-langgraph-23c26e9bf076)

[https://aws.amazon.com/blogs/machine-learning/build-a-multi-agent-system-with-langgraph-and-mistral-on-aws/](https://aws.amazon.com/blogs/machine-learning/build-a-multi-agent-system-with-langgraph-and-mistral-on-aws/) —\> IMP
